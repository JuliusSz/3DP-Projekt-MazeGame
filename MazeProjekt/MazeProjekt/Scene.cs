...
namespace MazeProjekt
{
    public class Scene
    {
        ...
        #region GameLoop
        /// <summary>
        /// Add MainCamera to list of existing GameObjects in scene
        /// overwrite Game Object as SpaceShip
        /// Add ModelRenderer Component to SpaceShip
        /// Add SpaceShip to list of existing GameObjects in scene
        /// </summary>
        public void Initialize()
        {
            ...
            player.camera = new Camera(new Vector3(0.5f, 0.5f, 0.5f), 0, 1.6f, 0.05f, 100f);
        }
